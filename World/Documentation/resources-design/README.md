...
7. [`07-localization-and-player-copy.md`](07-localization-and-player-copy.md) — Cliloc triplets (`CraftText` / `MaterialText` / `LowCaseText`), hardcoded harvest strings that may need localization, web summary guidance.
...
3. Prefer updating this folder in the **same PR** as gameplay changes touching `HarvestDefinition`/`CraftResources`.
