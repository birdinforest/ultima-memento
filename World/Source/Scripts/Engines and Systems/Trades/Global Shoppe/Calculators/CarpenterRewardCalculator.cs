...
{
	public sealed class CarpenterRewardCalculator : BaseCraftRewardCalculator<EquipmentOrderContext>
	{
		...
		protected override CraftItem FindCraftItem(Type type)
		{
			...
			Console.WriteLine("Failed to find carpentry craft item for '{0}'", type);
