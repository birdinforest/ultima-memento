...
namespace Server.Engines.GlobalShoppe
{
	public sealed class BowcraftRewardCalculator : BaseCraftRewardCalculator<EquipmentOrderContext>
	{
		...
		{
			return (int)(base.ComputePoints(context, order) * ShoppeOrderConstants.PointRatios.Bowyer);
		}

		protected override int ComputeReputation(TradeSkillContext context, EquipmentOrderContext order)
		{
			return (int)(base.ComputeReputation(context, order) * ShoppeOrderConstants.ReputationRatios.Bowyer);
		}
