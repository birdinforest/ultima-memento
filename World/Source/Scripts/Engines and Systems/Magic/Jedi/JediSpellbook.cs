...
namespace Server.Items
{
	...
	{
		public override string DefaultDescription{ get{ return StringCatalog.Resolve( null, "This datacron can hold ancient knowledge of the Jedi Order. Acquiring such abilities can only be achieved by finding the resting places of Jedi from long ago." ); } }
