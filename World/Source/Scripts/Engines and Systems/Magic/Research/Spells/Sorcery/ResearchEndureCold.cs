	...
	public class ResearchEndureCold : ResearchSpell
	{
        ...
        public override void OnCast()
        {
			if( CheckSequence() )
			{
				...
				for ( int i = 0; i < targets.Count; ++i )
				{
					...
					m.SendMessage( StringCatalog.Resolve( m.Account, "Your resistance to cold has increased." ) );
		...
		private class ExpireTimer : Timer
		{
			...
			protected override void OnTick()
			{
				if ( m_Mobile != null )
				{
					m_Mobile.SendMessage( StringCatalog.Resolve( m_Mobile.Account, "The cold protection effect has worn off." ) );
