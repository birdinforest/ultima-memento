...
namespace Server.Items
{
	...
	public class ResearchBag : Item
	{
        ...
        public override void AddNameProperties(ObjectPropertyList list)
		{
			...
			{
				AddLocalizedProperty( list, "item.research.bag" );
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			{
				ResearchLocalization.Send( from, "research.msg.pack_required", "This must be in your pack to do any research. " );
			}
			else if ( from.Skills[SkillName.Inscribe].Value < 30 )
			{
				ResearchLocalization.Send( from, "research.msg.inscribe_too_low", "You cannot understand anything that is in this bag." );
			}
			else if ( BagOwner != from )
			{
				ResearchLocalization.Send( from, "research.msg.not_owner_throw", "This bag doesn't belong to you so you throw it out." );
				bool remove = true;
		...
		public override bool OnDragDrop( Mobile from, Item dropped )
		{
			if ( BagOwner == from )
			{
				if ( dropped is BlankScroll )
				{
					if ( BagScrolls > 50000 )
					{
						ResearchLocalization.Send( from, "research.msg.scrolls_full", "This pack can only hold 50000 blank scrolls." );
					}
					else
					{
						from.PlaySound( 0x48 );
						...
						ResearchLocalization.Send( from, "research.msg.scrolls_added", "The blank scrolls have been added to your pack." );
				...
				else if ( dropped is ScribesPen )
				{
					...
					if ( BagQuills > 50000 )
					{
						ResearchLocalization.Send( from, "research.msg.quills_full", "This pack can only hold 50000 quills." );
					}
					else
					{
						from.PlaySound( 0x48 );
						...
						ResearchLocalization.Send( from, "research.msg.quills_added", "The quills have been added to your pack." );
				...
				else if ( dropped is Spellbook )
				{
					...
					book.Delete();
					ResearchLocalization.Send( from, "research.msg.created_spellbook", "Using your research, you make a new spellbook." );
		...
		public class ResearchGump : Gump
		{
			...
			public ResearchGump( ResearchBag bag, Mobile from ) : base( 50, 50 )
			{
				...
				if ( m_Page == 1 ) // MAIN SCREEN /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				{
					...
					AddHtml( 145+a, 163, 85, 20, ResearchLocalization.GumpHtml( from, "research.gump.label.scrolls", "Scrolls" ), (bool)false, (bool)false);
					...
					AddHtml( 444+a, 163, 85, 20, ResearchLocalization.GumpHtml( from, "research.gump.label.quills", "Quills" ), (bool)false, (bool)false);
					...
					AddHtml( 727+a, 163, 85, 20, ResearchLocalization.GumpHtml( from, "research.gump.label.ink", "Ink" ), (bool)false, (bool)false);
					AddHtml( 821+a, 163, 53, 20, @"<BODY><BASEFONT Color=#6cb89a>" + (bag.BagInk).ToString() + "</BASEFONT></BODY>", (bool)false, (bool)false);

					string msg = ResearchLocalization.Key( from, "research.gump.ink_full", "Your pack is fully stocked with octopus ink." );
					if ( bag.BagInk < 50000 ){ msg = ResearchLocalization.KeyFormat( from, "research.gump.ink_rumor", "More octopus ink is rumored to be at {0} in {1}.", bag.BagInkLocation, ResearchLocalization.LandName( from, bag.BagInkWorld ) ); }
					...
					if ( Research.GetResearch( bag, 1 ) )
					{
						...
						AddHtml( 161+a, 304, 204, 20, ResearchLocalization.GumpHtmlRaw( ResearchLocalization.KeyFormat( from, "research.gump.label.ancient_spell_bar", "Ancient Spell Bar {0}", "I" ) ), (bool)false, (bool)false);
						AddButton(436+a, 304, 4005, 4005, 1211, GumpButtonType.Reply, 0);
						AddHtml( 478+a, 304, 147, 20, ResearchLocalization.GumpHtml( from, "research.gump.label.open_toolbar", "Open Toolbar" ), (bool)false, (bool)false);
						AddButton(693+a, 304, 4017, 4017, 1221, GumpButtonType.Reply, 0);
						AddHtml( 734+a, 304, 147, 20, ResearchLocalization.GumpHtml( from, "research.gump.label.close_toolbar", "Close Toolbar" ), (bool)false, (bool)false);

						AddButton(121+a, 344, 4005, 4005, 1202, GumpButtonType.Reply, 0);
						AddHtml( 161+a, 344, 204, 20, ResearchLocalization.GumpHtmlRaw( ResearchLocalization.KeyFormat( from, "research.gump.label.ancient_spell_bar", "Ancient Spell Bar {0}", "II" ) ), (bool)false, (bool)false);
						AddButton(436+a, 344, 4005, 4005, 1212, GumpButtonType.Reply, 0);
						AddHtml( 478+a, 344, 147, 20, ResearchLocalization.GumpHtml( from, "research.gump.label.open_toolbar", "Open Toolbar" ), (bool)false, (bool)false);
						AddButton(693+a, 344, 4017, 4017, 1222, GumpButtonType.Reply, 0);
						AddHtml( 734+a, 344, 147, 20, ResearchLocalization.GumpHtml( from, "research.gump.label.close_toolbar", "Close Toolbar" ), (bool)false, (bool)false);

						AddButton(121+a, 384, 4005, 4005, 1203, GumpButtonType.Reply, 0);
						AddHtml( 161+a, 384, 204, 20, ResearchLocalization.GumpHtmlRaw( ResearchLocalization.KeyFormat( from, "research.gump.label.ancient_spell_bar", "Ancient Spell Bar {0}", "III" ) ), (bool)false, (bool)false);
						AddButton(436+a, 384, 4005, 4005, 1213, GumpButtonType.Reply, 0);
						AddHtml( 478+a, 384, 147, 20, ResearchLocalization.GumpHtml( from, "research.gump.label.open_toolbar", "Open Toolbar" ), (bool)false, (bool)false);
						AddButton(693+a, 384, 4017, 4017, 1223, GumpButtonType.Reply, 0);
						AddHtml( 734+a, 384, 147, 20, ResearchLocalization.GumpHtml( from, "research.gump.label.close_toolbar", "Close Toolbar" ), (bool)false, (bool)false);

						AddButton(121+a, 424, 4005, 4005, 1204, GumpButtonType.Reply, 0);
						AddHtml( 161+a, 424, 204, 20, ResearchLocalization.GumpHtmlRaw( ResearchLocalization.KeyFormat( from, "research.gump.label.ancient_spell_bar", "Ancient Spell Bar {0}", "IV" ) ), (bool)false, (bool)false);
						AddButton(436+a, 424, 4005, 4005, 1214, GumpButtonType.Reply, 0);
						AddHtml( 478+a, 424, 147, 20, ResearchLocalization.GumpHtml( from, "research.gump.label.open_toolbar", "Open Toolbar" ), (bool)false, (bool)false);
						AddButton(693+a, 424, 4017, 4017, 1224, GumpButtonType.Reply, 0);
						AddHtml( 734+a, 424, 147, 20, ResearchLocalization.GumpHtml( from, "research.gump.label.close_toolbar", "Close Toolbar" ), (bool)false, (bool)false);
					}
				}
				if ( m_Page == 2 ) // RUNES FOUND /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				{
					...
					r++;	Rune = Research.RuneName( from, r, 1 );	rune = Research.RuneName( r, 0 );	icon = 11277; if ( Research.GetRunes( bag, r ) ){ icon = Research.RuneIndex( rune, 1 ); } else if ( next > 0 ){ icon = 11278; next = 0; missing = Rune; }
					...
					string msg = ResearchLocalization.Key( from, "research.gump.cubes_all_found", "You have found all of the Cubes of Power." );
					if ( missing != "" ){ msg = ResearchLocalization.KeyFormat( from, "research.gump.cube_rumor", "The Cube of {0} is said to be in {1} in {2}.", missing, bag.RuneLocation, ResearchLocalization.LandName( from, bag.RuneWorld ) ); }
				...
				if ( m_Page == 3 || ( m_Page > 20 && m_Page < 30 ) ) // MAGERY RESEARCH
				{
					...
					AddHtml( 145+n, 150, 85, 20, ResearchLocalization.GumpHtmlRaw( ResearchLocalization.MageryCircle( from, 1 ) ), (bool)false, (bool)false);
					...
					if ( Research.GetWizardry( bag, 8 ) )
					{
						...
						AddHtml( 365+n, 150, 85, 20, ResearchLocalization.GumpHtmlRaw( ResearchLocalization.MageryCircle( from, 2 ) ), (bool)false, (bool)false);
					}
					if ( Research.GetWizardry( bag, 16 ) )
					{
						...
						AddHtml( 585+n, 150, 85, 20, ResearchLocalization.GumpHtmlRaw( ResearchLocalization.MageryCircle( from, 3 ) ), (bool)false, (bool)false);
					}
					if ( Research.GetWizardry( bag, 24 ) )
					{
						...
						AddHtml( 805+n, 150, 85, 20, ResearchLocalization.GumpHtmlRaw( ResearchLocalization.MageryCircle( from, 4 ) ), (bool)false, (bool)false);
					}
					if ( Research.GetWizardry( bag, 32 ) )
					{
						...
						AddHtml( 145+n, 190, 85, 20, ResearchLocalization.GumpHtmlRaw( ResearchLocalization.MageryCircle( from, 5 ) ), (bool)false, (bool)false);
					}
					if ( Research.GetWizardry( bag, 40 ) )
					{
						...
						AddHtml( 365+n, 190, 85, 20, ResearchLocalization.GumpHtmlRaw( ResearchLocalization.MageryCircle( from, 6 ) ), (bool)false, (bool)false);
					}
					if ( Research.GetWizardry( bag, 48 ) )
					{
						...
						AddHtml( 585+n, 190, 85, 20, ResearchLocalization.GumpHtmlRaw( ResearchLocalization.MageryCircle( from, 7 ) ), (bool)false, (bool)false);
					}
					if ( Research.GetWizardry( bag, 56 ) )
					{
						...
						AddHtml( 805+n, 190, 85, 20, ResearchLocalization.GumpHtmlRaw( ResearchLocalization.MageryCircle( from, 8 ) ), (bool)false, (bool)false);
					}
					...
					if ( Research.GetWizardry( bag, spellName ) )
					{
						...
						AddHtml( 195+n, 340, 176, 20, @"<BODY><BASEFONT Color=#6cb89a>" + Research.ScrollInformation( from, spellName, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					...
					if ( Research.GetWizardry( bag, spellName ) )
					{
						...
						AddHtml( 195+n, 390, 176, 20, @"<BODY><BASEFONT Color=#6cb89a>" + Research.ScrollInformation( from, spellName, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					...
					if ( Research.GetWizardry( bag, spellName ) )
					{
						...
						AddHtml( 195+n, 440, 176, 20, @"<BODY><BASEFONT Color=#6cb89a>" + Research.ScrollInformation( from, spellName, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					...
					if ( Research.GetWizardry( bag, spellName ) )
					{
						...
						AddHtml( 195+n, 490, 176, 20, @"<BODY><BASEFONT Color=#6cb89a>" + Research.ScrollInformation( from, spellName, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					...
					if ( Research.GetWizardry( bag, spellName ) )
					{
						...
						AddHtml( 750+n, 340, 176, 20, @"<BODY><BASEFONT Color=#6cb89a>" + Research.ScrollInformation( from, spellName, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					...
					if ( Research.GetWizardry( bag, spellName ) )
					{
						...
						AddHtml( 750+n, 390, 176, 20, @"<BODY><BASEFONT Color=#6cb89a>" + Research.ScrollInformation( from, spellName, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					...
					if ( Research.GetWizardry( bag, spellName ) )
					{
						...
						AddHtml( 750+n, 440, 176, 20, @"<BODY><BASEFONT Color=#6cb89a>" + Research.ScrollInformation( from, spellName, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					...
					if ( Research.GetWizardry( bag, spellName ) )
					{
						...
						AddHtml( 750+n, 490, 176, 20, @"<BODY><BASEFONT Color=#6cb89a>" + Research.ScrollInformation( from, spellName, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
						AddButton(710+n, 490, 4011, 4011, 300+spellName, GumpButtonType.Reply, 0);
					} spellName++;

					string msg = ResearchLocalization.KeyFormat( from, "research.gump.magery_all_researched", "You have researched all of the {0} magery spells.", ResearchLocalization.MageryCircleWord( from, spellCircle ) );
					string nextSpell = Research.NextWizardryForDisplay( from, bag );
					...
					{
						msg = ResearchLocalization.KeyFormat( from, "research.gump.magery_next", "To learn the {0} spell you need to find {1} at {2} in {3}.", nextSpell, bag.SpellsMageItem, bag.SpellsMageLocation, ResearchLocalization.LandName( from, bag.SpellsMageWorld ) );
					}
				...
				if ( m_Page == 4 ) // NECROMANCY RESEARCH /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				{
					...
					if ( Research.GetNecromancy( bag, spellName ) )
					{
						...
						AddHtml( 195+n, 235, 176, 20, @"<BODY><BASEFONT Color=#6cb89a>" + Research.ScrollInformation( from, spellName+64, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					} spellName++;
					if ( Research.GetNecromancy( bag, spellName ) )
					{
						...
						AddHtml( 195+n, 265, 176, 20, @"<BODY><BASEFONT Color=#6cb89a>" + Research.ScrollInformation( from, spellName+64, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					} spellName++;
					if ( Research.GetNecromancy( bag, spellName ) )
					{
						...
						AddHtml( 195+n, 295, 176, 20, @"<BODY><BASEFONT Color=#6cb89a>" + Research.ScrollInformation( from, spellName+64, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					} spellName++;
					if ( Research.GetNecromancy( bag, spellName ) )
					{
						...
						AddHtml( 195+n, 325, 176, 20, @"<BODY><BASEFONT Color=#6cb89a>" + Research.ScrollInformation( from, spellName+64, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					} spellName++;
					if ( Research.GetNecromancy( bag, spellName ) )
					{
						...
						AddHtml( 195+n, 355, 176, 20, @"<BODY><BASEFONT Color=#6cb89a>" + Research.ScrollInformation( from, spellName+64, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					} spellName++;
					if ( Research.GetNecromancy( bag, spellName ) )
					{
						...
						AddHtml( 195+n, 385, 176, 20, @"<BODY><BASEFONT Color=#6cb89a>" + Research.ScrollInformation( from, spellName+64, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					} spellName++;
					if ( Research.GetNecromancy( bag, spellName ) )
					{
						...
						AddHtml( 195+n, 415, 176, 20, @"<BODY><BASEFONT Color=#6cb89a>" + Research.ScrollInformation( from, spellName+64, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					} spellName++;
					if ( Research.GetNecromancy( bag, spellName ) )
					{
						...
						AddHtml( 195+n, 445, 176, 20, @"<BODY><BASEFONT Color=#6cb89a>" + Research.ScrollInformation( from, spellName+64, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					} spellName++;
					if ( Research.GetNecromancy( bag, spellName ) )
					{
						...
						AddHtml( 195+n, 475, 176, 20, @"<BODY><BASEFONT Color=#6cb89a>" + Research.ScrollInformation( from, spellName+64, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					} spellName++;
					if ( Research.GetNecromancy( bag, spellName ) )
					{
						...
						AddHtml( 700+n, 235, 176, 20, @"<BODY><BASEFONT Color=#6cb89a>" + Research.ScrollInformation( from, spellName+64, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					} spellName++;
					if ( Research.GetNecromancy( bag, spellName ) )
					{
						...
						AddHtml( 700+n, 265, 176, 20, @"<BODY><BASEFONT Color=#6cb89a>" + Research.ScrollInformation( from, spellName+64, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					} spellName++;
					if ( Research.GetNecromancy( bag, spellName ) )
					{
						...
						AddHtml( 700+n, 295, 176, 20, @"<BODY><BASEFONT Color=#6cb89a>" + Research.ScrollInformation( from, spellName+64, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					} spellName++;
					if ( Research.GetNecromancy( bag, spellName ) )
					{
						...
						AddHtml( 700+n, 325, 176, 20, @"<BODY><BASEFONT Color=#6cb89a>" + Research.ScrollInformation( from, spellName+64, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					} spellName++;
					if ( Research.GetNecromancy( bag, spellName ) )
					{
						...
						AddHtml( 700+n, 355, 176, 20, @"<BODY><BASEFONT Color=#6cb89a>" + Research.ScrollInformation( from, spellName+64, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					} spellName++;
					if ( Research.GetNecromancy( bag, spellName ) )
					{
						...
						AddHtml( 700+n, 385, 176, 20, @"<BODY><BASEFONT Color=#6cb89a>" + Research.ScrollInformation( from, spellName+64, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					} spellName++;
					if ( Research.GetNecromancy( bag, spellName ) )
					{
						...
						AddHtml( 700+n, 415, 176, 20, @"<BODY><BASEFONT Color=#6cb89a>" + Research.ScrollInformation( from, spellName+64, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					} spellName++;
					if ( Research.GetNecromancy( bag, spellName ) )
					{
						...
						AddHtml( 700+n, 445, 176, 20, @"<BODY><BASEFONT Color=#6cb89a>" + Research.ScrollInformation( from, spellName+64, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					} spellName++;

					string msg = ResearchLocalization.Key( from, "research.gump.necro_all_researched", "You have researched all of the necromancy spells." );
					string nextSpell = Research.NextNecromancyForDisplay( from, bag );
					...
					{
						msg = ResearchLocalization.KeyFormat( from, "research.gump.necro_next", "To learn the {0} spell you need to find {1} at {2} in {3}.", nextSpell, bag.SpellsNecroItem, bag.SpellsNecroLocation, ResearchLocalization.LandName( from, bag.SpellsNecroWorld ) );
					}
				...
				if ( m_Page == 5 || ( m_Page > 30 && m_Page < 40 ) ) // ANCIENT RESEARCH //////////////////////////////////////////////////////////////////////////////////////////////////////////////
				{
					...
					AddHtml( 185+r, 150, 85, 20, ResearchLocalization.GumpHtmlRaw( ResearchLocalization.AncientSchool( from, "conjuration" ) ), (bool)false, (bool)false);
					...
					AddHtml( 378+r, 150, 85, 20, ResearchLocalization.GumpHtmlRaw( ResearchLocalization.AncientSchool( from, "death" ) ), (bool)false, (bool)false);
					...
					AddHtml( 586+r, 150, 85, 20, ResearchLocalization.GumpHtmlRaw( ResearchLocalization.AncientSchool( from, "enchanting" ) ), (bool)false, (bool)false);
					...
					AddHtml( 784+r, 150, 85, 20, ResearchLocalization.GumpHtmlRaw( ResearchLocalization.AncientSchool( from, "sorcery" ) ), (bool)false, (bool)false);
					...
					AddHtml( 185+r, 190, 85, 20, ResearchLocalization.GumpHtmlRaw( ResearchLocalization.AncientSchool( from, "summoning" ) ), (bool)false, (bool)false);
					...
					AddHtml( 378+r, 190, 95, 20, ResearchLocalization.GumpHtmlRaw( ResearchLocalization.AncientSchool( from, "thaumaturgy" ) ), (bool)false, (bool)false);
					...
					AddHtml( 586+r, 190, 85, 20, ResearchLocalization.GumpHtmlRaw( ResearchLocalization.AncientSchool( from, "theurgy" ) ), (bool)false, (bool)false);
					...
					AddHtml( 784+r, 190, 85, 20, ResearchLocalization.GumpHtmlRaw( ResearchLocalization.AncientSchool( from, "wizardry" ) ), (bool)false, (bool)false);
					...
					if ( Research.GetResearch( bag, spellName ) )
					{
						...
						AddHtml( 195+r, 340, 176, 20, @"<BODY><BASEFONT Color=#6cb89a>" + Research.SpellInformation( from, spellName, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					...
					if ( Research.GetResearch( bag, spellName ) )
					{
						...
						AddHtml( 195+r, 390, 176, 20, @"<BODY><BASEFONT Color=#6cb89a>" + Research.SpellInformation( from, spellName, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					...
					if ( Research.GetResearch( bag, spellName ) )
					{
						...
						AddHtml( 195+r, 440, 176, 20, @"<BODY><BASEFONT Color=#6cb89a>" + Research.SpellInformation( from, spellName, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					...
					if ( Research.GetResearch( bag, spellName ) )
					{
						...
						AddHtml( 195+r, 490, 176, 20, @"<BODY><BASEFONT Color=#6cb89a>" + Research.SpellInformation( from, spellName, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					...
					if ( Research.GetResearch( bag, spellName ) )
					{
						...
						AddHtml( 750+r, 340, 176, 20, @"<BODY><BASEFONT Color=#6cb89a>" + Research.SpellInformation( from, spellName, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					...
					if ( Research.GetResearch( bag, spellName ) )
					{
						...
						AddHtml( 750+r, 390, 176, 20, @"<BODY><BASEFONT Color=#6cb89a>" + Research.SpellInformation( from, spellName, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					...
					if ( Research.GetResearch( bag, spellName ) )
					{
						...
						AddHtml( 750+r, 440, 176, 20, @"<BODY><BASEFONT Color=#6cb89a>" + Research.SpellInformation( from, spellName, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					...
					if ( Research.GetResearch( bag, spellName ) )
					{
						...
						AddHtml( 750+r, 490, 176, 20, @"<BODY><BASEFONT Color=#6cb89a>" + Research.SpellInformation( from, spellName, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
						AddButton(710+r, 490, 4011, 4011, 500+spellName, GumpButtonType.Reply, 0);
					} spellName+=8;

					string msg = ResearchLocalization.KeyFormat( from, "research.gump.ancient_all_researched", "You have researched all of the ancient {0} spells.", ResearchLocalization.AncientSchool( from, spellCircle ) );
					string nextSpell = Research.NextResearchForDisplay( from, bag );
					...
					{
						msg = ResearchLocalization.KeyFormat( from, "research.gump.ancient_next", "To learn the magic of {0} you need to find {1} at {2} in {3}.", nextSpell, bag.ResearchItem, bag.ResearchLocation, ResearchLocalization.LandName( from, bag.ResearchWorld ) );
					}
				...
				if ( m_Page == 6 || ( m_Page > 40 && m_Page < 50 ) ) // ANCIENT PREPARED SPELLS ///////////////////////////////////////////////////////////////////////////////////////////////////////
				{
					...
					if ( Research.GetResearch( bag, spellName ) )
					{
						...
						AddHtml( 120+r, 275, 250, 20, @"<BODY><BASEFONT Color=#6cb89a>" + Research.SpellInformation( from, spellName, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					...
					if ( Research.GetResearch( bag, spellName ) )
					{
						...
						AddHtml( 120+r, 365, 250, 20, @"<BODY><BASEFONT Color=#6cb89a>" + Research.SpellInformation( from, spellName, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					...
					if ( Research.GetResearch( bag, spellName ) )
					{
						...
						AddHtml( 120+r, 455, 250, 20, @"<BODY><BASEFONT Color=#6cb89a>" + Research.SpellInformation( from, spellName, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					...
					if ( Research.GetResearch( bag, spellName ) )
					{
						...
						AddHtml( 120+r, 545, 250, 20, @"<BODY><BASEFONT Color=#6cb89a>" + Research.SpellInformation( from, spellName, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					...
					if ( Research.GetResearch( bag, spellName ) )
					{
						...
						AddHtml( 620+shft, 275, 250, 20, @"<BODY><BASEFONT Color=#6cb89a>" + Research.SpellInformation( from, spellName, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					...
					if ( Research.GetResearch( bag, spellName ) )
					{
						...
						AddHtml( 620+shft, 365, 250, 20, @"<BODY><BASEFONT Color=#6cb89a>" + Research.SpellInformation( from, spellName, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					...
					if ( Research.GetResearch( bag, spellName ) )
					{
						...
						AddHtml( 620+shft, 455, 250, 20, @"<BODY><BASEFONT Color=#6cb89a>" + Research.SpellInformation( from, spellName, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					...
					if ( Research.GetResearch( bag, spellName ) )
					{
						...
						AddHtml( 620+shft, 545, 250, 20, @"<BODY><BASEFONT Color=#6cb89a>" + Research.SpellInformation( from, spellName, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
		...
		private class SpellInformation : Gump
		{
			...
			public SpellInformation( ResearchBag bag, Mobile from, int page, int spell, int area ) : base( 50, 50 )
			{
				...
				if ( area > 0 )
				{
					...
					AddHtml( 12, 12, 317, 20, @"<BODY><BASEFONT Color=#ddbc4b>" + Research.SpellInformation( from, spell, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					AddHtml( 18, 142, 564, 230, @"<BODY><BASEFONT Color=#ddbc4b>" + Research.SpellInformation( from, spell, 3 ) + ResearchLocalization.Key( from, "research.gump.spellinfo.school_suffix", " School of Magic<br><br>" ) + Research.SpellInformation( from, spell, 6 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					AddHtml( 252, 71, 74, 20, @"<BODY><BASEFONT Color=#ddbc4b>" + ResearchLocalization.Key( from, "research.gump.spellinfo.mana", "Mana:" ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					AddHtml( 336, 71, 74, 20, @"<BODY><BASEFONT Color=#ddbc4b>" + Research.SpellInformation( spell, 7 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					AddHtml( 252, 105, 74, 20, @"<BODY><BASEFONT Color=#ddbc4b>" + ResearchLocalization.Key( from, "research.gump.spellinfo.skill", "Skill:" ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					...
					string reagents = Research.SpellInformation( from, spell, 5 );
						if ( reagents.Contains(", ") ){ reagents = reagents.Replace(", ", "<br>"); }

                    int g = 0;

                    AddHtml(348, 391 + g, 234, 125, @"<BODY><BASEFONT Color=#ddbc4b>" + ResearchLocalization.KeyFormat( from, "research.gump.spellinfo.reagents", "REAGENTS:<BR>{0}", reagents ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
                    AddHtml(155, 394 + g, 120, 20, @"<BODY><BASEFONT Color=#ddbc4b>" + ResearchLocalization.Key( from, "research.gump.spellinfo.scribe_one", "Scribe One" ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
                    AddHtml(155, 440 + g, 120, 20, @"<BODY><BASEFONT Color=#ddbc4b>" + ResearchLocalization.Key( from, "research.gump.spellinfo.scribe_most", "Scribe Most" ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
				...
				else
				{
					...
					AddHtml( 55, 356, 160, 20, @"<BODY><BASEFONT Color=#ddbc4b>" + ResearchLocalization.Key( from, "research.gump.spellinfo.scribe_spell", "Scribe Spell" ) + "</BASEFONT></BODY>", (bool)false, (bool)false);

					AddHtml( 12, 14, 299, 20, @"<BODY><BASEFONT Color=#ddbc4b>" + Research.ScrollInformation( from, spell, 2 ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					AddItem(306, 17, 3636);
					AddItem(399, 9, 8273);
					...
					AddHtml( 12, 450, 61, 20, @"<BODY><BASEFONT Color=#ddbc4b>" + ResearchLocalization.Key( from, "research.gump.spellinfo.skill", "Skill:" ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					AddHtml( 12, 495, 61, 20, @"<BODY><BASEFONT Color=#ddbc4b>" + ResearchLocalization.Key( from, "research.gump.spellinfo.mana", "Mana:" ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
					...
					string reagents = Research.ScrollInformation( from, spell, 3 );
						if ( reagents.Contains(", ") ){ reagents = reagents.Replace(", ", "<br>"); }

					AddHtml( 486, 430, 166, 100, @"<BODY><BASEFONT Color=#ddbc4b>" + ResearchLocalization.KeyFormat( from, "research.gump.spellinfo.reagents", "REAGENTS:<BR>{0}", reagents ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
				}
			}
