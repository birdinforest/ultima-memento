...
namespace Server.Spells.Syth
{
	public class Projection : SythSpell
	{
		...
		public override bool CheckCast()
		{
			...
			{
				Caster.SendMessage( StringCatalog.Resolve( Caster.Account, "You have too many followers to create a projection." ) );
				return false;
			}
		...
		public override void OnCast()
		{
			...
			{
				Caster.SendMessage( StringCatalog.Resolve( Caster.Account, "You cannot create a projection while you look like that." ) );
			}
