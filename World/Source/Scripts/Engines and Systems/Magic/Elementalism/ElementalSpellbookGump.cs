...
{ 
	public class ElementalSpellbookGump : Gump 
	{
		...
		public ElementalSpellbookGump( Mobile from, ElementalSpellbook book, int page ) : base( 100, 100 ) 
		{
			...
			if ( page == 1 ) // MAIN PAGE
			{
				AddHtml( 85, 12, 89, 20, @"<BODY><BASEFONT Color=" + fnt + "><BIG>" + StringCatalog.Resolve( from.Account, "Elemental" ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 207, 12, 89, 20, @"<BODY><BASEFONT Color=" + fnt + "><BIG>" + StringCatalog.Resolve( from.Account, "Spellbook" ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 34, 35, 133, 160, @"<BODY><BASEFONT Color=" + fnt + ">" + StringCatalog.Resolve( from.Account, "Known elemental spells can be cast by selecting the button next to each listed spell. A known spell will also have a red bookmark on its detail page you can click on to cast as well." ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 188, 35, 133, 160, @"<BODY><BASEFONT Color=" + fnt + ">" + StringCatalog.Resolve( from.Account, "Each spell has the power needed to cast, which is the amount of mana and stamina the caster needs. The bookmark below can be selected to view the information on how this magic works." ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
			}
			else if ( page > 1 && page < 6 ) // SPELL LISTS
			{
				...
				AddHtml( 59, 14, 100, 20, @"<BODY><BASEFONT Color=" + fnt + "><BIG>" + StringCatalog.Resolve( from.Account, "Sphere " ) + seca + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 207, 14, 100, 20, @"<BODY><BASEFONT Color=" + fnt + "><BIG>" + StringCatalog.Resolve( from.Account, "Sphere " ) + secb + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

				id++;
				if ( HasSpell(from, id) ){ AddButton(35, 55, 2224, 2224, id, GumpButtonType.Reply, 0); }
				AddHtml( 60, 50, 102, 20, @"<BODY><BASEFONT Color=" + fnt + "><BIG>" + ElementalSpell.CommonInfo( from.Account, id, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				...
				AddHtml( 60, 90, 102, 20, @"<BODY><BASEFONT Color=" + fnt + "><BIG>" + ElementalSpell.CommonInfo( from.Account, id, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				...
				AddHtml( 60, 130, 102, 20, @"<BODY><BASEFONT Color=" + fnt + "><BIG>" + ElementalSpell.CommonInfo( from.Account, id, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				...
				AddHtml( 60, 170, 102, 20, @"<BODY><BASEFONT Color=" + fnt + "><BIG>" + ElementalSpell.CommonInfo( from.Account, id, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				...
				AddHtml( 215, 50, 102, 20, @"<BODY><BASEFONT Color=" + fnt + "><BIG>" + ElementalSpell.CommonInfo( from.Account, id, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				...
				AddHtml( 215, 90, 102, 20, @"<BODY><BASEFONT Color=" + fnt + "><BIG>" + ElementalSpell.CommonInfo( from.Account, id, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				...
				AddHtml( 215, 130, 102, 20, @"<BODY><BASEFONT Color=" + fnt + "><BIG>" + ElementalSpell.CommonInfo( from.Account, id, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				...
				AddHtml( 215, 170, 102, 20, @"<BODY><BASEFONT Color=" + fnt + "><BIG>" + ElementalSpell.CommonInfo( from.Account, id, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			...
			else // SPELL DESCRIPTIONS
			{
				...
				AddHtml( 34, 184, 100, 20, @"<BODY><BASEFONT Color=" + fnt + "><BIG>" + StringCatalog.Resolve( from.Account, "Elementalism:" ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 139, 184, 38, 20, @"<BODY><BASEFONT Color=" + fnt + "><BIG>" + skill + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

				AddHtml( 190, 14, 100, 20, @"<BODY><BASEFONT Color=" + fnt + "><BIG>" + StringCatalog.Resolve( from.Account, "Sphere " ) + sphere + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 189, 38, 134, 159, @"<BODY><BASEFONT Color=" + fnt + ">" + ElementalSpell.DescriptionInfo( from.Account, spell, m_Book.ItemID ) + "</BASEFONT></BODY>", (bool)false, (bool)false);
