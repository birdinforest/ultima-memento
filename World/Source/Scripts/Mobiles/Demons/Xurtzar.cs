...
{
	public class XurtzarChest : Item, IVaultRelicEligible
	{
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			{
				from.SendSound( 0x3D );
				from.PrivateOverheadMessage(MessageType.Regular, 1150, false, StringCatalog.ResolveByKey(null, "mob.other.you_have_pulled_xurtzar_s_vault_toward_you"), from.NetState);
