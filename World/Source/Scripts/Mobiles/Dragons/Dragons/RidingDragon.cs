	...
	public class RidingDragon : BaseMount
	{
				...
				if ( iRuined != null )
				{
					...
					else if ( iRuined is BaseWeapon )
					{
						...
						if ( CraftResources.GetType( iRuined.Resource ) == CraftResourceType.Metal )
						{
							...
							{
								m.LocalOverheadMessage(MessageType.Emote, 1150, true, StringCatalog.ResolveByKey(m.Account, "mob.other.the_dragon_almost_rusted_one_of_your_protected_items"));
							}
							else
							{
								m.LocalOverheadMessage(MessageType.Emote, 0x916, true, StringCatalog.ResolveByKey(m.Account, "mob.other.the_dragon_rusted_one_of_your_equipped_items"));
		...
		public override void OnDeath( Container c )
		{
			...
			if ( rBody != 61 )
			{
				...
				if ( Utility.RandomMinMax( 1, 200 ) == 1 && !Controlled )
				{
