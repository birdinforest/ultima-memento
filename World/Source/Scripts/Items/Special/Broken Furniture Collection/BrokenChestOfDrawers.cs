...
namespace Server.Items
{
	...
	public class BrokenChestOfDrawersDeed : BaseAddonDeed
	{
		...
		public override void AddNameProperty( ObjectPropertyList list )
		{
			...
			{
				if ( Amount <= 1 )
					AddLocalizedProperty( list, "item.special.deed.broken.chest.drawers" );
				else
					list.Add( 1050039, "{0}\t{1}", Amount, ResolvePropertyText( "item.special.deed.broken.chest.drawers" ) );
				return;
			}
