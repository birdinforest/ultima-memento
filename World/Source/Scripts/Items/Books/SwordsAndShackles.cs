...
namespace Server.Items
{
	public class SwordsAndShackles : Item
	{
		...
		public class SwordsAndShacklesGump : Gump
		{
			...
			private static string LocalizeBookHtml( Mobile from, string enHtml )
			{
				if ( from == null )
					return enHtml;
				string lang = AccountLang.GetLanguageCode( from.Account );
				string s = StringCatalog.TryResolve( lang, enHtml ) ?? enHtml;
