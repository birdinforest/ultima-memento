...
namespace Server.Items
{
	public class SewingKitRunicI : BaseTool, IRunicTool
	{
		...
		public override string DisplayNameLocalizationKey => "item.trade.name.runic.sewing.kit.1";
	...
	public class SewingKitRunicII : BaseTool, IRunicTool
	{
		...
		public override string DisplayNameLocalizationKey => "item.trade.name.runic.sewing.kit.2";
	...
	public class SewingKitRunicIII : BaseTool, IRunicTool
	{
		...
		public override string DisplayNameLocalizationKey => "item.trade.name.runic.sewing.kit.3";
