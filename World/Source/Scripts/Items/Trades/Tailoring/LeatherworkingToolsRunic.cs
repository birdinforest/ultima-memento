...
namespace Server.Items
{
	public class LeatherworkingToolsRunicI : BaseTool, IRunicTool
	{
		...
		public override string DisplayNameLocalizationKey => "item.trade.name.runic.tanning.tools.1";
	...
	public class LeatherworkingToolsRunicII : BaseTool, IRunicTool
	{
		...
		public override string DisplayNameLocalizationKey => "item.trade.name.runic.tanning.tools.2";
	...
	public class LeatherworkingToolsRunicIII : BaseTool, IRunicTool
	{
		...
		public override string DisplayNameLocalizationKey => "item.trade.name.runic.tanning.tools.3";
