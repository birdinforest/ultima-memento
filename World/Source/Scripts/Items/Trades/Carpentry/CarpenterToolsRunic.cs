...
namespace Server.Items
{
	public class CarpenterToolsRunicI : BaseTool, IRunicTool
	{
		...
		public override string DisplayNameLocalizationKey => "item.trade.name.runic.carpenter.tools.1";
	...
	public class CarpenterToolsRunicII : BaseTool, IRunicTool
	{
		...
		public override string DisplayNameLocalizationKey => "item.trade.name.runic.carpenter.tools.2";
	...
	public class CarpenterToolsRunicIII : BaseTool, IRunicTool
	{
		...
		public override string DisplayNameLocalizationKey => "item.trade.name.runic.carpenter.tools.3";
