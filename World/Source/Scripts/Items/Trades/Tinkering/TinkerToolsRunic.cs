...
namespace Server.Items
{
	public class TinkerToolsRunicI : BaseTool, IRunicTool
	{
		...
		public override string DisplayNameLocalizationKey => "item.trade.name.runic.tinker.tools.1";
	...
	public class TinkerToolsRunicII : BaseTool, IRunicTool
	{
		...
		public override string DisplayNameLocalizationKey => "item.trade.name.runic.tinker.tools.2";
	...
	public class TinkerToolsRunicIII : BaseTool, IRunicTool
	{
		...
		public override string DisplayNameLocalizationKey => "item.trade.name.runic.tinker.tools.3";
