...
namespace Server.Items
{
	public class NeptunesFishingNet : Item
	{
		...
		public override void AddNameProperty( ObjectPropertyList list )
		{
			...
			{
				AddLocalizedProperty( list, "item.trade.neptunes.fishing.net" );
				return;
			}
        ...
        public override void AddNameProperties(ObjectPropertyList list)
		{
			...
			if ( BuildingPropertyListLocale != null )
			{
				AddLocalizedProperty( list, "prop.trade.fishing.net.use.high.seas" );
				AddLocalizedProperty( list, "prop.trade.fishing.net.requires.seafaring", "100" );
			}
			else
			{
