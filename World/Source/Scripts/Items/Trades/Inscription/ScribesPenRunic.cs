...
namespace Server.Items
{
	public class ScribesPenRunicI : BaseTool, IRunicTool
	{
		...
		public override string DisplayNameLocalizationKey => "item.trade.name.runic.scribe.quill.1";
	...
	public class ScribesPenRunicII : BaseTool, IRunicTool
	{
		...
		public override string DisplayNameLocalizationKey => "item.trade.name.runic.scribe.quill.2";
	...
	public class ScribesPenRunicIII : BaseTool, IRunicTool
	{
		...
		public override string DisplayNameLocalizationKey => "item.trade.name.runic.scribe.quill.3";
