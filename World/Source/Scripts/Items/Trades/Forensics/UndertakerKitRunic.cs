...
namespace Server.Items
{
	public class UndertakerKitRunicI : BaseTool, IRunicTool
	{
		...
		public override string DisplayNameLocalizationKey => "item.trade.name.runic.undertaker.kit.1";
	...
	public class UndertakerKitRunicII : BaseTool, IRunicTool
	{
		...
		public override string DisplayNameLocalizationKey => "item.trade.name.runic.undertaker.kit.2";
	...
	public class UndertakerKitRunicIII : BaseTool, IRunicTool
	{
		...
		public override string DisplayNameLocalizationKey => "item.trade.name.runic.undertaker.kit.3";
