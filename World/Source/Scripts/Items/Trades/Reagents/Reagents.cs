...
namespace Server.Items
{
	public class reagents_magic_jar1 : Item
	{
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			{
				from.SendMessage( StringCatalog.ResolveByKey( from.Account, "prop.trade.reagents.jar.msg.pack" ) );
				return;
			}
			else
			{
				...
				from.PrivateOverheadMessage(MessageType.Regular, 0x14C, false, StringCatalog.ResolveByKey( from.Account, "prop.trade.reagents.jar.msg.dump" ), from.NetState);
				this.Delete();
			}
		}
		...
		public override void AddNameProperties(ObjectPropertyList list)
		{
			...
			if ( BuildingPropertyListLocale != null )
			{
				AddLocalizedProperty( list, "prop.trade.reagents.jar.wizard.contains" );
				AddLocalizedProperty( list, "prop.trade.reagents.jar.empty" );
			}
			else
			{
	...
	public class reagents_magic_jar2 : Item
	{
		...
		public override void AddNameProperties(ObjectPropertyList list)
		{
			...
			if ( BuildingPropertyListLocale != null )
			{
				AddLocalizedProperty( list, "prop.trade.reagents.jar.necro.contains" );
				AddLocalizedProperty( list, "prop.trade.reagents.jar.empty" );
			}
			else
			{
	...
	public class reagents_magic_jar3 : Item
	{
		...
		public override void AddNameProperties(ObjectPropertyList list)
		{
			...
			if ( BuildingPropertyListLocale != null )
			{
				AddLocalizedProperty( list, "prop.trade.reagents.jar.alchemy.contains" );
				AddLocalizedProperty( list, "prop.trade.reagents.jar.empty" );
			}
			else
			{
