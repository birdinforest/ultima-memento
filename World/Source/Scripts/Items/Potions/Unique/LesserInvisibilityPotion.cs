...
namespace Server.Items
{
	...
	{
		public override string DefaultDescription{ get{ return StringCatalog.Resolve( null, "Drinking this potion will make you invisible, and also give you mastery skill in both hiding and stealth. These potions do not allow one to stealth in heavy armor. The potion's effect lasts for 1 minute." ); } }
