...
namespace Server.Items
{
	public abstract class BaseFrostbitePotion : BasePotion
	{
		...
		public override string DefaultDescription{ get{ return StringCatalog.ResolveFormat( null, "These potions will create a field of cold, where walking through it will cause between {0} and {1} damage. The field lasts for about 30 seconds.", MinDamage, MaxDamage ); } }
