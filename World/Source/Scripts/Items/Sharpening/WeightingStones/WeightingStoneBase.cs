...
namespace Server.Items
{
    public abstract class WeightingStoneBase : Item
    {
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            from.SendMessage(StringCatalog.Resolve(from.Account, "Which weapon you want to try to weight?"));
        ...
        protected void ApplyValues(Mobile from, BaseWeapon weapon)
        {
            ...
            {
                from.SendMessage(32, StringCatalog.Resolve(from.Account, "You fail to weight the weapon"));
            }
        }
