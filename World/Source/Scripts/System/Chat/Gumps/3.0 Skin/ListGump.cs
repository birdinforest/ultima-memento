    ...
    public class ListGump : GumpPlus
    {
        ...
        protected override void BuildGump()
        {
            ...
            else if(c_ListPage != ListPage.Notifications)
            {
                ...
                AddHtml(0, y += 20, width, "<CENTER>" + states.Count + " " + General.LocalFor(Owner, 19));
            }
            ...
            AddHtml(0, y, width, "<CENTER>" + General.LocalFor(Owner, 19 + (int)Data.GetData(Current).Status));
        ...
        private void ShowMenu(int x)
        {
            ...
            AddHtml(x, y += 25, width, "<CENTER>" + General.LocalFor(Owner, 38));
            ...
            AddHtml(x, y += 25, width, "<CENTER>" + General.LocalFor(Owner, 1));
            AddImage(x + 10, y + 2, 0x39);
            AddImage(x + width - 40, y + 2, 0x3B);

            AddHtml(x, y += 25, width, "<CENTER>" + General.LocalFor(Owner, 46));
            ...
            AddHtml(x, y += 20, width, "<CENTER>" + General.LocalFor(Owner, 56));
            ...
            AddHtml(x, y += 20, width, "<CENTER>" + General.LocalFor(Owner, 203));
            ...
            AddHtml(x, y += 20, width, "<CENTER>" + General.LocalFor(Owner, 51));
            ...
            AddHtml(x, y += 20, width, (c_ListPage == ListPage.Channel ? "" : HTML.Gray) + "<CENTER>" + General.LocalFor(Owner, 206));
            ...
            if (Data.GetData(Current).GlobalAccess)
            {
                AddHtml(x, y += 20, width, HTML.Red + "<CENTER>" + General.LocalFor(Owner, 204));
                ...
                AddHtml(x, y += 20, width, HTML.Red + "<CENTER>" + General.LocalFor(Owner, 205));
            ...
            {
                AddHtml(x, y += 20, width, HTML.Red + "<CENTER>" + General.LocalFor(Owner, 54));
                ...
                AddHtml(x, y += 20, width, HTML.Red + "<CENTER>" + General.LocalFor(Owner, 269));
            ...
            AddHtml(x, y+=25, width, "<CENTER>" + General.LocalFor(Owner, 40));
            AddImage(x + 10, y + 2, 0x39);
            AddImage(x + width - 40, y + 2, 0x3B);

            AddHtml(x, y += 25, width, "<CENTER>" + General.LocalFor(Owner, 49));
            ...
            if (Data.GetData(Current).GlobalAccess)
            {
                AddHtml(x, y += 20, width, HTML.Red + "<CENTER>" + General.LocalFor(Owner, 43));
            ...
            {
                AddHtml(x, y += 20, width, HTML.LightPurple + "<CENTER>" + General.LocalFor(Owner, 207));
                AddButton(x + 20, y + 3, 0x2716, "General", new GumpCallback(GenOpt));
                AddButton(x + width - 30, y + 3, 0x2716, "General", new GumpCallback(GenOpt));
                AddHtml(x, y += 20, width, HTML.LightPurple + "<CENTER>" + General.LocalFor(Owner, 237));
