...
namespace Knives.Chat3
{
    public class IrcGump : GumpPlus
    {
        ...
        protected override void BuildGump()
        {
            ...
            AddHtml(0, y, width, "<CENTER>" + General.LocalFor(Owner, 100));
            ...
            AddHtml(0, y += 20, width, "<CENTER>" + General.LocalFor(Owner, 98));
            ...
            AddHtml(0, y += 25, width, "<CENTER>" + General.LocalFor(Owner, 115));
            ...
            AddHtml(0, y+=20, width, "<CENTER>" + General.LocalFor(Owner, 116));
            ...
            AddHtml(0, y += 25, width, "<CENTER>" + General.LocalFor(Owner, 138) + ": " + General.LocalFor(Owner, 121 + (int)Data.IrcStaffColor));
            ...
            AddHtml(0, y += 25, width / 2 - 10, "<DIV ALIGN=RIGHT>" + General.LocalFor(Owner, 117));
            ...
            AddHtml(0, y += 20, width / 2 - 10, "<DIV ALIGN=RIGHT>" + General.LocalFor(Owner, 118));
            AddTextField(width / 2 + 10, y, 100, 21, 0x480, 0xBBA, "Server", Data.IrcServer);
            AddButton(width / 2 - 5, y + 4, 0x2716, "Submit", new GumpCallback(Submit));

            AddHtml(0, y += 20, width / 2 - 10, "<DIV ALIGN=RIGHT>" + General.LocalFor(Owner, 119));
        ...
        private class IrcStaffColorGump : GumpPlus
        {
            ...
            protected override void BuildGump()
            {
                ...
                AddHtml(0, y, width, "<CENTER>" + General.LocalFor(Owner, 137));
                ...
                for (int i = 0; i < 16; ++i)
                {
                    AddHtml(0, y += 20, width, "<CENTER>" + General.LocalFor(Owner, 121 + i));
