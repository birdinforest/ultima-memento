...
namespace Knives.Chat3
{
    public class GlobalGump : GumpPlus
    {
        ...
        protected override void BuildGump()
        {
            ...
            AddHtml(0, y, width, "<CENTER>" + General.LocalFor(Owner, 226));
            ...
            AddHtml(0, y += 25, width, "<CENTER>" + General.LocalFor(Owner, 43) + " | " + General.LocalFor(Owner, 10));
            ...
            if (Data.GetData(Current).Global)
            {
                ...
                AddHtml(0, y += 20, width, "<CENTER>" + General.LocalFor(Owner, 45));
                ...
                AddHtml(0, y += 20, width, "<CENTER>" + General.LocalFor(Owner, 26));
                ...
                AddHtml(0, y += 20, width, "<CENTER>" + General.LocalFor(Owner, 192));
                ...
                AddHtml(0, y += 20, width, "<CENTER>" + General.LocalFor(Owner, 193));
                ...
                AddHtml(0, y += 20, width, "<CENTER>" + General.LocalFor(Owner, 159));
