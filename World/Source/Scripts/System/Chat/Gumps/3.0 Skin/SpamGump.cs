...
namespace Knives.Chat3
{
    public class SpamGump : GumpPlus
    {
        ...
        protected override void BuildGump()
        {
            ...
            AddHtml(0, y, width, "<CENTER>" + General.LocalFor(Owner, 215));
            AddImage(width / 2 - 100, y + 2, 0x39);
            AddImage(width / 2 + 70, y + 2, 0x3B);

            AddHtml(0, y += 25, width/2-10, "<DIV ALIGN=RIGHT>" + General.LocalFor(Owner, 144));
            ...
            AddHtml(0, y+=25, width/2-10, "<DIV ALIGN=RIGHT>" + General.LocalFor(Owner, 145));
            AddTextField(width/2+10, y, 30, 21, 0x480, 0xBBA, "Msg Spam", "" + Data.MsgSpam);
            AddHtml(width/2+45, y, 20, "s");
            AddButton(width / 2 - 5, y + 4, 0x2716, "Submit", new GumpCallback(Submit));

            AddHtml(0, y += 25, width/2-10, "<DIV ALIGN=RIGHT>" + General.LocalFor(Owner, 146));
