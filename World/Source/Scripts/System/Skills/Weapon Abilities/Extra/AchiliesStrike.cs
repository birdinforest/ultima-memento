...
namespace Server.Items
{
	public class AchillesStrike : WeaponAbility
	{
		...
		public override void OnHit(Mobile attacker, Mobile defender, int damage)
		{
			...
			attacker.SendMessage(StringCatalog.Resolve(attacker.Account, "You damage their Achilles tendon!"));
			defender.SendMessage(StringCatalog.Resolve(defender.Account, "Your Achilles tendon was hurt!"));
