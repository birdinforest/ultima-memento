...
namespace Server.Items
{
	public class ZapStrStrike : WeaponAbility
	{
		...
		public override void OnHit(Mobile attacker, Mobile defender, int damage)
		{
			...
			attacker.SendMessage(StringCatalog.Resolve(attacker.Account, "You have drained their strength!"));
			defender.SendMessage(StringCatalog.Resolve(defender.Account, "You feel weaker from the blow!"));
