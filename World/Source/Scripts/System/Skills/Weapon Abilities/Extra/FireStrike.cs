...
namespace Server.Items
{
	public class FireStrike : WeaponAbility
	{
		...
		public override void OnHit(Mobile attacker, Mobile defender, int damage)
		{
			...
			attacker.SendMessage(StringCatalog.Resolve(attacker.Account, "You strike them with burning force!"));
			defender.SendMessage(StringCatalog.Resolve(defender.Account, "You where struck with burning force!"));
