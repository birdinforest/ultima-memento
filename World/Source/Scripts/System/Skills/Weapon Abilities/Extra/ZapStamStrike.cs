...
namespace Server.Items
{
	public class ZapStamStrike : WeaponAbility
	{
		...
		public override void OnHit(Mobile attacker, Mobile defender, int damage)
		{
			...
			attacker.SendMessage(StringCatalog.Resolve(attacker.Account, "You have drained their stamina!"));
			defender.SendMessage(StringCatalog.Resolve(defender.Account, "You feel exhausted from the blow!"));
