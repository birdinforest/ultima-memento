...
namespace Server.SkillHandlers
{
	...
	public class TrackWhatGump : Gump
	{
		...
		public TrackWhatGump( Mobile from ) : base( 50, 50 )
		{
			...
			AddHtml( 12, 12, 385, 20, @"<BODY><BASEFONT Color=" + color + ">" + StringCatalog.ResolveByKey(from.Account, "skl.tracking.title") + @"</BASEFONT></BODY>", (bool)false, (bool)false);

			int y = 45;
			int x = 15;

			AddHtml( x+35, y, 145, 20, @"<BODY><BASEFONT Color=" + color + ">" + StringCatalog.ResolveByKey(from.Account, "skl.tracking.cat.abysmal") + @"</BASEFONT></BODY>", (bool)false, (bool)false);
			AddButton(x, y, 4005, 4005, 1, GumpButtonType.Reply, 0);
			y = y + 30;
			AddHtml( x+70, y, 145, 20, @"<BODY><BASEFONT Color=" + subct + ">" + StringCatalog.ResolveByKey(from.Account, "skl.tracking.cat.daemons") + @"</BASEFONT></BODY>", (bool)false, (bool)false);
			AddButton(x+35, y, 4005, 4005, 2, GumpButtonType.Reply, 0);
			y = y + 30;
			AddHtml( x+70, y, 145, 20, @"<BODY><BASEFONT Color=" + subct + ">" + StringCatalog.ResolveByKey(from.Account, "skl.tracking.cat.devils") + @"</BASEFONT></BODY>", (bool)false, (bool)false);
			AddButton(x+35, y, 4005, 4005, 3, GumpButtonType.Reply, 0);
			y = y + 30;
			AddHtml( x+70, y, 145, 20, @"<BODY><BASEFONT Color=" + subct + ">" + StringCatalog.ResolveByKey(from.Account, "skl.tracking.cat.gargoyles") + @"</BASEFONT></BODY>", (bool)false, (bool)false);
			AddButton(x+35, y, 4005, 4005, 4, GumpButtonType.Reply, 0);
			y = y + 30;
			AddHtml( x+35, y, 145, 20, @"<BODY><BASEFONT Color=" + color + ">" + StringCatalog.ResolveByKey(from.Account, "skl.tracking.cat.animals") + @"</BASEFONT></BODY>", (bool)false, (bool)false);
			AddButton(x, y, 4005, 4005, 5, GumpButtonType.Reply, 0);
			y = y + 30;
			AddHtml( x+35, y, 145, 20, @"<BODY><BASEFONT Color=" + color + ">" + StringCatalog.ResolveByKey(from.Account, "skl.tracking.cat.arachnids") + @"</BASEFONT></BODY>", (bool)false, (bool)false);
			AddButton(x, y, 4005, 4005, 7, GumpButtonType.Reply, 0);
			y = y + 30;
			AddHtml( x+70, y, 145, 20, @"<BODY><BASEFONT Color=" + subct + ">" + StringCatalog.ResolveByKey(from.Account, "skl.tracking.cat.arachnoids") + @"</BASEFONT></BODY>", (bool)false, (bool)false);
			AddButton(x+35, y, 4005, 4005, 8, GumpButtonType.Reply, 0);
			y = y + 30;
			AddHtml( x+70, y, 145, 20, @"<BODY><BASEFONT Color=" + subct + ">" + StringCatalog.ResolveByKey(from.Account, "skl.tracking.cat.scorpions") + @"</BASEFONT></BODY>", (bool)false, (bool)false);
			AddButton(x+35, y, 4005, 4005, 9, GumpButtonType.Reply, 0);
			y = y + 30;
			AddHtml( x+70, y, 145, 20, @"<BODY><BASEFONT Color=" + subct + ">" + StringCatalog.ResolveByKey(from.Account, "skl.tracking.cat.spiders") + @"</BASEFONT></BODY>", (bool)false, (bool)false);
			AddButton(x+35, y, 4005, 4005, 10, GumpButtonType.Reply, 0);
			y = y + 30;
			AddHtml( x+35, y, 145, 20, @"<BODY><BASEFONT Color=" + color + ">" + StringCatalog.ResolveByKey(from.Account, "skl.tracking.cat.avians") + @"</BASEFONT></BODY>", (bool)false, (bool)false);
			AddButton(x, y, 4005, 4005, 6, GumpButtonType.Reply, 0);
			y = y + 30;
			AddHtml( x+35, y, 145, 20, @"<BODY><BASEFONT Color=" + color + ">" + StringCatalog.ResolveByKey(from.Account, "skl.tracking.cat.elementals") + @"</BASEFONT></BODY>", (bool)false, (bool)false);
			AddButton(x, y, 4005, 4005, 11, GumpButtonType.Reply, 0);
			y = y + 30;
			AddHtml( x+35, y, 145, 20, @"<BODY><BASEFONT Color=" + color + ">" + StringCatalog.ResolveByKey(from.Account, "skl.tracking.cat.fey") + @"</BASEFONT></BODY>", (bool)false, (bool)false);
			AddButton(x, y, 4005, 4005, 12, GumpButtonType.Reply, 0);
			y = y + 30;
			AddHtml( x+35, y, 145, 20, @"<BODY><BASEFONT Color=" + color + ">" + StringCatalog.ResolveByKey(from.Account, "skl.tracking.cat.giants") + @"</BASEFONT></BODY>", (bool)false, (bool)false);
			AddButton(x, y, 4005, 4005, 13, GumpButtonType.Reply, 0);
			y = y + 30;
			AddHtml( x+35, y, 145, 20, @"<BODY><BASEFONT Color=" + color + ">" + StringCatalog.ResolveByKey(from.Account, "skl.tracking.cat.golems") + @"</BASEFONT></BODY>", (bool)false, (bool)false);
			AddButton(x, y, 4005, 4005, 14, GumpButtonType.Reply, 0);
			y = y + 30;
			AddHtml( x+35, y, 145, 20, @"<BODY><BASEFONT Color=" + color + ">" + StringCatalog.ResolveByKey(from.Account, "skl.tracking.cat.monsters_general") + @"</BASEFONT></BODY>", (bool)false, (bool)false);
			AddButton(x, y, 4005, 4005, 32, GumpButtonType.Reply, 0);
			y = y + 30;
			AddHtml( x+35, y, 378, 20, @"<BODY><BASEFONT Color=" + color + ">" + StringCatalog.ResolveByKey(from.Account, "skl.tracking.cat.others") + @"</BASEFONT></BODY>", (bool)false, (bool)false);
			AddButton(x, y, 4005, 4005, 15, GumpButtonType.Reply, 0);

			y = 45;
			x = 298;

			AddHtml( x+35, y, 145, 20, @"<BODY><BASEFONT Color=" + color + ">" + StringCatalog.ResolveByKey(from.Account, "skl.tracking.cat.humanoids") + @"</BASEFONT></BODY>", (bool)false, (bool)false);
			AddButton(x, y, 4005, 4005, 16, GumpButtonType.Reply, 0);
			y = y + 30;
			AddHtml( x+70, y, 145, 20, @"<BODY><BASEFONT Color=" + subct + ">" + StringCatalog.ResolveByKey(from.Account, "skl.tracking.cat.ogres") + @"</BASEFONT></BODY>", (bool)false, (bool)false);
			AddButton(x+35, y, 4005, 4005, 17, GumpButtonType.Reply, 0);
			y = y + 30;
			AddHtml( x+70, y, 145, 20, @"<BODY><BASEFONT Color=" + subct + ">" + StringCatalog.ResolveByKey(from.Account, "skl.tracking.cat.orcs") + @"</BASEFONT></BODY>", (bool)false, (bool)false);
			AddButton(x+35, y, 4005, 4005, 18, GumpButtonType.Reply, 0);
			y = y + 30;
			AddHtml( x+70, y, 145, 20, @"<BODY><BASEFONT Color=" + subct + ">" + StringCatalog.ResolveByKey(from.Account, "skl.tracking.cat.people") + @"</BASEFONT></BODY>", (bool)false, (bool)false);
			AddButton(x+35, y, 4005, 4005, 19, GumpButtonType.Reply, 0);
			y = y + 30;
			AddHtml( x+70, y, 145, 20, @"<BODY><BASEFONT Color=" + subct + ">" + StringCatalog.ResolveByKey(from.Account, "skl.tracking.cat.players") + @"</BASEFONT></BODY>", (bool)false, (bool)false);
			AddButton(x+35, y, 4005, 4005, 20, GumpButtonType.Reply, 0);
			y = y + 30;
			AddHtml( x+70, y, 145, 20, @"<BODY><BASEFONT Color=" + subct + ">" + StringCatalog.ResolveByKey(from.Account, "skl.tracking.cat.trolls") + @"</BASEFONT></BODY>", (bool)false, (bool)false);
			AddButton(x+35, y, 4005, 4005, 21, GumpButtonType.Reply, 0);
			y = y + 30;
			AddHtml( x+35, y, 145, 20, @"<BODY><BASEFONT Color=" + color + ">" + StringCatalog.ResolveByKey(from.Account, "skl.tracking.cat.plants") + @"</BASEFONT></BODY>", (bool)false, (bool)false);
			AddButton(x, y, 4005, 4005, 22, GumpButtonType.Reply, 0);
			y = y + 30;
			AddHtml( x+35, y, 145, 20, @"<BODY><BASEFONT Color=" + color + ">" + StringCatalog.ResolveByKey(from.Account, "skl.tracking.cat.reptiles") + @"</BASEFONT></BODY>", (bool)false, (bool)false);
			AddButton(x, y, 4005, 4005, 23, GumpButtonType.Reply, 0);
			y = y + 30;
			AddHtml( x+70, y, 145, 20, @"<BODY><BASEFONT Color=" + subct + ">" + StringCatalog.ResolveByKey(from.Account, "skl.tracking.cat.dragons") + @"</BASEFONT></BODY>", (bool)false, (bool)false);
			AddButton(x+35, y, 4005, 4005, 24, GumpButtonType.Reply, 0);
			y = y + 30;
			AddHtml( x+70, y, 145, 20, @"<BODY><BASEFONT Color=" + subct + ">" + StringCatalog.ResolveByKey(from.Account, "skl.tracking.cat.lizardmen") + @"</BASEFONT></BODY>", (bool)false, (bool)false);
			AddButton(x+35, y, 4005, 4005, 25, GumpButtonType.Reply, 0);
			y = y + 30;
			AddHtml( x+70, y, 145, 20, @"<BODY><BASEFONT Color=" + subct + ">" + StringCatalog.ResolveByKey(from.Account, "skl.tracking.cat.serpentoids") + @"</BASEFONT></BODY>", (bool)false, (bool)false);
			AddButton(x+35, y, 4005, 4005, 26, GumpButtonType.Reply, 0);
			y = y + 30;
			AddHtml( x+70, y, 145, 20, @"<BODY><BASEFONT Color=" + subct + ">" + StringCatalog.ResolveByKey(from.Account, "skl.tracking.cat.snakes") + @"</BASEFONT></BODY>", (bool)false, (bool)false);
			AddButton(x+35, y, 4005, 4005, 27, GumpButtonType.Reply, 0);
			y = y + 30;
			AddHtml( x+35, y, 145, 20, @"<BODY><BASEFONT Color=" + color + ">" + StringCatalog.ResolveByKey(from.Account, "skl.tracking.cat.sea") + @"</BASEFONT></BODY>", (bool)false, (bool)false);
			AddButton(x, y, 4005, 4005, 28, GumpButtonType.Reply, 0);
			y = y + 30;
			AddHtml( x+35, y, 145, 20, @"<BODY><BASEFONT Color=" + color + ">" + StringCatalog.ResolveByKey(from.Account, "skl.tracking.cat.slimy") + @"</BASEFONT></BODY>", (bool)false, (bool)false);
			AddButton(x, y, 4005, 4005, 29, GumpButtonType.Reply, 0);
			y = y + 30;
			AddHtml( x+35, y, 145, 20, @"<BODY><BASEFONT Color=" + color + ">" + StringCatalog.ResolveByKey(from.Account, "skl.tracking.cat.supernatural") + @"</BASEFONT></BODY>", (bool)false, (bool)false);
			AddButton(x, y, 4005, 4005, 30, GumpButtonType.Reply, 0);
			y = y + 30;
			AddHtml( x+35, y, 145, 20, @"<BODY><BASEFONT Color=" + color + ">" + StringCatalog.ResolveByKey(from.Account, "skl.tracking.cat.wizards") + @"</BASEFONT></BODY>", (bool)false, (bool)false);
	...
	public class TrackWhoGump : Gump
	{
		...
		private TrackWhoGump( Mobile from, List<Mobile> list, int range ) : base( 50, 50 )
		{
			...
			AddHtml( 12, 12, 385, 20, @"<BODY><BASEFONT Color=" + hue + ">" + StringCatalog.ResolveByKey(from.Account, "skl.tracking.title") + @"</BASEFONT></BODY>", (bool)false, (bool)false);
