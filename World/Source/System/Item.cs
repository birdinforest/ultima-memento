...
namespace Server
{
	...
	public class Item : IEntity, IHued, IComparable<Item>, ISerializable, ISpawnable
	{
		...
		private static readonly Dictionary<string, string> PropertyColorMap = new Dictionary<string, string>
		{
			...
			{ "prop.poison.lesser",			"2E8B57" },
			{ "prop.poison.regular",		"2E8B57" },
			{ "prop.poison.greater",		"2E8B57" },
			{ "prop.poison.deadly",			"2E8B57" },
			{ "prop.poison.lethal",			"2E8B57" },
			{ "prop.equipped.at",			"808080" },
			{ "prop.density.weak",			"808080" },
			{ "prop.density.regular",		"808080" },
			{ "prop.density.great",			"808080" },
			{ "prop.density.greater",		"808080" },
			{ "prop.density.superior",		"808080" },
			{ "prop.density.ultimate",		"808080" },
			{ "prop.arcane.charges",		"9370DB" },
			{ "gift.enchant.prompt",		"DAA520" },
			{ "gift.enchant.points",		"DAA520" },
			{ "gift.provenance",			"808080" },
			{ "gift.throwing.change.type",		"808080" },
			{ "gift.throwing.no.weapons",		"808080" },
			{ "gift.pugilist.no.weapons",		"808080" },
			{ "god.level",				"DAA520" },
			{ "god.experience",			"808080" },
			{ "god.legendary.only",			"DAA520" },
			{ "god.must.validate",			"808080" },
			{ "god.validated",			"2E8B57" },
			{ "god.rename.uses.left",		"808080" },
			{ "god.rename.legendary",		"DAA520" },
			{ "god.rename.belongs.to",		"808080" },
			{ "god.xp.token",			"808080" },
			{ "god.candle.unequip",			"808080" },
			{ "god.candle.equip",			"808080" },
