...
传奇矿工掘出了矮人矿石。
传奇伐木工采得精灵之木
编年之谈之间的帷幕在变稀薄，有家酒肆说埃克索达斯（Exodus）已灭亡，有家却说它仍在暗处蠢动。
朝圣者离了埃克索达斯（Exodus）城堡归来，皮囊里多出未认下的墨迹。
城镇传令官为与轶书《渐薄之幕》（The Thinning Veil）相关的耳语收取酬金。
时间领主（Time Lord）絮语爱、索尔、月与亡者的次第，听者只觉时辰在脚下悄然滑移。
""".strip().splitlines()
