...
SHARED_ZH = {
    "quest.epic.gump.shared.info": (
        "<br><br>这些贡品可按你的冒险风格定制。取得贡品后，单击物品并选择「附魔」，菜单会列出可分配的属性点数。"
        "须谨慎——属性一经选定便无法更改；点数用尽后，物品将保持最终状态。"
    ),
    "quest.epic.gump.shared.bare.neutral": (
        "<br><br>{0} 愿在你寻得一件稀世之物后赠你贡品……<br><br>{1}<br><br>……且你的声望至少达到 7,000 点。"
        "若接受贡品，声望将减少 7,000 点，需重新累积。若已达标，请单击 {0} 并选择「贡品」以挑选物品类型。"
        "{0} 亦需至少 5,000 金币方能为你打造物品。"
    ),
    "quest.epic.gump.shared.bare.good": (
        "<br><br>{0} 愿在你寻得一件稀世之物后赠你贡品……<br><br>{1}<br><br>……且你的声望至少 4,000 点、"
        "善恶值（Karma）至少 4,000 点。若接受贡品，声望与善恶值各减 4,000 点，需重新累积。若已达标，请单击 {0} 并选择「贡品」"
        "以挑选物品类型。{0} 亦需至少 5,000 金币方能为你打造物品。"
    ),
    "quest.epic.gump.shared.bare.evil": (
        "<br><br>{0} 愿在你寻得一件稀世之物后赠你贡品……<br><br>{1}<br><br>……且你的声望至少 4,000 点、"
        "善恶值（Karma）至多 -4,000 点。若接受贡品，声望将减 4,000 点、善恶值将增 4,000 点，需重新累积。若已达标，请单击 {0} "
        "并选择「贡品」以挑选物品类型。{0} 亦需至少 5,000 金币方能为你打造物品。"
    ),
}
