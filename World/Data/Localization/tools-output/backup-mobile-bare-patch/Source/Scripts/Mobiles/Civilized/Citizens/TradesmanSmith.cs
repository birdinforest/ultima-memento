...
namespace Server.Mobiles
{
	public class TradesmanSmith : Citizens
	{
		...
		public override void OnAfterSpawn()
		{
			...
			hammer.Name = StringCatalog.ResolveByKey(null, "mob.other.hammer");
...
namespace Server.Items
{
	...
	public class AnvilHit : Item
	{
		...
		{
			Name = StringCatalog.ResolveByKey(null, "mob.other.anvil");
			Movable = false;
			Weight = -2.0;
		}
...
namespace Server.Items
{
	public class CrateOfMetal : Item
	{
		...
		{
			Name = StringCatalog.ResolveByKey(null, "mob.other.crate_of_ingots");
			Weight = 10;
		...
		public void Fill()
		{
			...
			Name = StringCatalog.ResolveFormatByKey(null, "mob.fmt.crate_of_0_ingots", CraftResources.GetName(Resource));
        ...
        public override void AddNameProperties(ObjectPropertyList list)
		{
			...
			list.Add( 1070722, Server.Localization.StringCatalog.ResolveFormatByKey(null, "mob.fmt.contains_0_1_ingots", Limits, CraftResources.GetName(Resource) ) );
