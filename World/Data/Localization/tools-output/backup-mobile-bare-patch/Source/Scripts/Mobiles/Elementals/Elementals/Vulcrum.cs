...
namespace Server.Mobiles
{
	...
	public class Vulcrum : BaseCreature
	{
		...
		{
			Name = Server.Localization.StringCatalog.ResolveByKey(null, "mob.other.vulcrum");
			Title = Server.Localization.StringCatalog.ResolveByKey(null, "mob.other.of_the_flame");
			Body = 16;
			Hue = 0x489;
			BaseSoundID = 838;
			EmoteHue = 123;
...
namespace Server.Items
{
	public class VulcrumChest : Item
	{
		...
		{
			Name = Server.Localization.StringCatalog.ResolveByKey(null, "mob.other.vulcrum_s_vault");
			Movable = false;
			Hue = 0x4EA;
		...
		public override void OnDoubleClick( Mobile from )
		{
			if ( from.InRange( this.GetWorldLocation(), 2 ) )
			{
				...
				MyChest.Name = Server.Localization.StringCatalog.ResolveByKey(null, "mob.other.vulcrum_s_vault");
				MyChest.Hue = 0x4EA;
				...
				if ( from is PlayerMobile )
				{
					if ( GetPlayerInfo.LuckyKiller( from.Luck ) && !Server.Misc.PlayerSettings.GetSpecialsKilled( from, "Vulcrum" ) )
					{
						...
						ManualOfItems lexicon = new ManualOfItems();
							lexicon.Hue = 0x4EA;
							lexicon.Name = Server.Localization.StringCatalog.ResolveByKey(null, "mob.other.chest_of_vulcrum_relics");
							lexicon.m_Charges = 1;
							lexicon.m_Skill_1 = 0;
							lexicon.m_Skill_2 = 0;
							lexicon.m_Skill_3 = 0;
