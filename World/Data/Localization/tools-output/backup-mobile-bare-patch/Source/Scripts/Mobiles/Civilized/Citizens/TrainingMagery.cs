	...
	public class TrainingMagery : Citizens
	{
		...
		public override void OnAfterSpawn()
		{
			...
			if ( Utility.RandomBool() )
			{
				...
				wand.Name = StringCatalog.ResolveByKey(null, "mob.other.magic_wand");
...
namespace Server.Items
{
	public class MagicHit : Item
	{
		...
		{
			Name = StringCatalog.ResolveByKey(null, "mob.other.magic_target");
			Visible = false;
			Movable = false;
			Weight = -2.0;
		}
...
namespace Server.Mobiles
{
	...
	public class SpellCritter : BaseCreature
	{
		...
		{
			Name = StringCatalog.ResolveByKey(null, "mob.other.target");
			Body = 0;
			BaseSoundID = 0;
			Hidden = true;
			CantWalk = true;
