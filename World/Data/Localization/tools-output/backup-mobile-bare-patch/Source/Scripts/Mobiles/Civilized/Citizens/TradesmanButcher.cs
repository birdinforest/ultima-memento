...
namespace Server.Mobiles
{
	public class TradesmanButcher : Citizens
	{
		...
		public override void OnAfterSpawn()
		{
			...
			cleaver.Name = StringCatalog.ResolveByKey(null, "mob.other.cleaver");
...
namespace Server.Items
{
	public class ButcherHit : Item
	{
		...
		{
			Name = StringCatalog.ResolveByKey(null, "mob.other.carcass");
			Movable = false;
			Weight = -2.0;
...
namespace Server.Items
{
	public class CrateOfMeats : Item
	{
		...
		{
			Name = StringCatalog.ResolveByKey(null, "mob.other.crate_of_meat");
			Weight = 10;
		}
