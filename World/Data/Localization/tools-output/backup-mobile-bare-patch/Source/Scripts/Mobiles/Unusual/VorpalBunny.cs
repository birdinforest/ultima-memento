...

{
...

	{
...

		{
			...
			Name = Server.Localization.StringCatalog.ResolveByKey(null, "mob.other.a_vorpal_bunny");
...

		{
...

			{
				...
				Name = Server.Localization.StringCatalog.ResolveByKey(null, "mob.other.a_mysterious_rabbit_hole");
