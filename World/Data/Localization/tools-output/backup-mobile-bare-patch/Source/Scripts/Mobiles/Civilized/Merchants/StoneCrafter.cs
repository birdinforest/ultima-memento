...
namespace Server.Mobiles
{
	...
	public class StoneCrafter : BaseVendor
	{
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			if ( Title == Server.Localization.StringCatalog.ResolveByKey(null, "mob.other.the_stonecrafter") )
				Title = Server.Localization.StringCatalog.ResolveByKey(null, "mob.other.the_stone_crafter");
		}
	}
}