...
namespace Server.Items
{
	public class PackBeastItem : Item
	{
		...
		public PackBeastItem() : base( 0x2126 )
		{
			...
			Name = Server.Localization.StringCatalog.ResolveByKey(null, "mob.other.pack_animal");
			Weight = 1.0;
			PorterSerial = 0;
			Charges = 5;
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			else
			{
				...
				else
				{
					...
					friend.Hue = this.Hue;
					if ( PorterName != null ){ friend.Name = PorterName; } else { friend.Name = Server.Localization.StringCatalog.ResolveByKey(null, "mob.other.a_pack_animal"); }
