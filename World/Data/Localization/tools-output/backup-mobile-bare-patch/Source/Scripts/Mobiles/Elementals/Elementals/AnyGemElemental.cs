...
namespace Server.Mobiles
{
	...
	public class AnyGemElemental : BaseCreature
	{
		...
		public AnyGemElemental() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			...
			{
				case 1:	RealName = Server.Localization.StringCatalog.ResolveByKey(null, "mob.other.a_garnet_grue"); break;
				case 2:	RealName = Server.Localization.StringCatalog.ResolveByKey(null, "mob.other.an_obsidian_grue"); break;
				case 3:	RealName = Server.Localization.StringCatalog.ResolveByKey(null, "mob.other.a_quartz_grue"); break;
				case 4:	RealName = Server.Localization.StringCatalog.ResolveByKey(null, "mob.other.a_silver_grue"); break;
				case 5:	RealName = Server.Localization.StringCatalog.ResolveByKey(null, "mob.other.a_spinel_grue"); break;
				case 6:	RealName = Server.Localization.StringCatalog.ResolveByKey(null, "mob.other.a_star_ruby_grue"); break;
				case 7:	RealName = Server.Localization.StringCatalog.ResolveByKey(null, "mob.other.a_topaz_grue"); break;
			}
