...
namespace Server.Mobiles
{
	...
	public class Necromental : BaseCreature
	{
		...
		{
			Name = Server.Localization.StringCatalog.ResolveByKey(null, "mob.other.a_necromental");
			Body = 14;
			Hue = 0x763;
			BaseSoundID = 268;
...
namespace Server.Items
{
	...
	public class GraveStones : Item
	{
		...
		{
			Weight = 10.0;
			Name = Server.Localization.StringCatalog.ResolveByKey(null, "mob.other.grave_stone");
			Hue = 0x763;
