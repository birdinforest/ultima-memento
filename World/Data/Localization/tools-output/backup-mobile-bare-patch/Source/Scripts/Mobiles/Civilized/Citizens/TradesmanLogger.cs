...
namespace Server.Mobiles
{
	public class TradesmanLogger : Citizens
	{
		...
		public override void OnAfterSpawn()
		{
			...
			axe.Name = StringCatalog.ResolveByKey(null, "mob.other.axe");
...
namespace Server.Items
{
	public class TreeHit : Item
	{
		...
		{
			Name = StringCatalog.ResolveByKey(null, "mob.other.tree");
			Visible = false;
			Movable = false;
			Weight = -2.0;
		}
...
namespace Server.Items
{
	public class CrateOfWood : Item
	{
		...
		{
			Name = StringCatalog.ResolveByKey(null, "mob.other.crate_of_boards");
			Weight = 10;
		...
		public void Fill()
		{
			...
			Name = StringCatalog.ResolveFormatByKey(null, "mob.fmt.crate_of_0_boards", CraftResources.GetName(Resource));
        ...
        public override void AddNameProperties(ObjectPropertyList list)
		{
			...
			list.Add( 1070722, Server.Localization.StringCatalog.ResolveFormatByKey(null, "mob.fmt.contains_0_1_boards", Limits, CraftResources.GetName(Resource) ) );
	...
	public class CrateOfLogs : Item
	{
		...
		{
			Name = StringCatalog.ResolveByKey(null, "mob.other.crate_of_logs");
			Weight = 10;
			Limits = Utility.RandomMinMax( 4, 12 ) * 100;
			Fill();
		}
		...
		public void Fill()
		{
			...
			Name = StringCatalog.ResolveFormatByKey(null, "mob.fmt.crate_of_0_logs", CraftResources.GetName(Resource));
			Hue = CraftResources.GetHue(Resource);
        ...
        public override void AddNameProperties(ObjectPropertyList list)
		{
			...
			list.Add( 1070722, Server.Localization.StringCatalog.ResolveFormatByKey(null, "mob.fmt.contains_0_1_logs", Limits, CraftResources.GetName(Resource) ) );
			list.Add( 1049644, Server.Localization.StringCatalog.ResolveByKey(null, "mob.other.open_to_remove_them_from_the_crate") );
        }
