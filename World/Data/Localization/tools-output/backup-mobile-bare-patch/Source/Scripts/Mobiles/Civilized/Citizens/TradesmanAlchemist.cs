...
namespace Server.Items
{
	public class CauldronHit : Item
	{
		...
		{
			Name = StringCatalog.ResolveByKey(null, "mob.other.cauldron");
			Movable = false;
...
namespace Server.Items
{
	public class CrateOfReagents : Item
	{
		...
		{
			Name = StringCatalog.ResolveByKey(null, "mob.other.crate_of_reagents");
			Weight = 10;
		}
	...
	public class CrateOfPotions : Item
	{
		...
		{
			Name = StringCatalog.ResolveByKey(null, "mob.other.crate_of_potions");
			Weight = 10;
		}
