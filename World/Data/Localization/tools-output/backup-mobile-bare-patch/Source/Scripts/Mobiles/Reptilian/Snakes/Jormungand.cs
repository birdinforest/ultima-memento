...

{
...

	{
...

		{
			...
			Name = Server.Localization.StringCatalog.ResolveByKey(null, "mob.other.jormungandr");

			Title = Server.Localization.StringCatalog.ResolveByKey(null, "mob.other.the_midgard_serpent");
...

{
...

	{
...

		{
			...
			Name = Server.Localization.StringCatalog.ResolveByKey(null, "mob.other.statue_of_jormungandr");
