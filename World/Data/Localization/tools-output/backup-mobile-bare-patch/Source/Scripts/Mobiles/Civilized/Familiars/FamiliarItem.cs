...
namespace Server.Items
{
	public class HenchmanFamiliarItem : Item
	{
		...
		[CommandProperty(AccessLevel.Owner)]
		public Mobile Familiar_Owner{ get { return FamiliarOwner; } set { FamiliarOwner = value; InvalidateProperties(); } }
		...
		public HenchmanFamiliarItem() : base( 0x4FD6 )
		{
			...
			Name = Server.Localization.StringCatalog.ResolveByKey(null, "mob.other.crystal_ball_of_summoning");
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			else
			{
				...
				friend.Hue = this.Hue;
				if ( FamiliarName != null ){ friend.Name = FamiliarName; } else { friend.Name = Server.Localization.StringCatalog.ResolveByKey(null, "mob.other.a_familiar"); }
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			FamiliarOwner = reader.ReadMobile();
