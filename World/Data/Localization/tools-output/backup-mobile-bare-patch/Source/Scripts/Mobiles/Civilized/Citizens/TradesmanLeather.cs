...
namespace Server.Items
{
	...
	public class LeatherHit : Item
	{
		...
		{
			Name = StringCatalog.ResolveByKey(null, "mob.other.stretched_hide");
			Movable = false;
			Weight = -2.0;
		}
...
namespace Server.Items
{
	public class CrateOfLeather : Item
	{
		...
		{
			Name = StringCatalog.ResolveByKey(null, "mob.other.crate_of_leather");
			Weight = 10;
		...
		public void Fill()
		{
			...
			Name = StringCatalog.ResolveFormatByKey(null, "mob.fmt.crate_of_0_leather", CraftResources.GetName(Resource));
        ...
        public override void AddNameProperties(ObjectPropertyList list)
		{
			...
			list.Add( 1070722, Server.Localization.StringCatalog.ResolveFormatByKey(null, "mob.fmt.contains_0_1_leather", Limits, CraftResources.GetName(Resource) ) );
