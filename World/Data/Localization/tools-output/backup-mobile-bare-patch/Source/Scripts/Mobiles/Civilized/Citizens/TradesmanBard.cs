...
namespace Server.Items
{
	public class BardHit : Item
	{
		...
		{
			Name = StringCatalog.ResolveByKey(null, "mob.other.instrument");
			Movable = false;
			Weight = -2.0;
			ItemID = 0x27B3;
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			if ( from is TradesmanBard )
			{
				...
				{
					if ( this.ItemID == 0x64BE || this.ItemID == 0x64BF ){ 		this.Name = StringCatalog.ResolveByKey(null, "mob.other.instrument");	from.PlaySound( Utility.RandomList( 0x4C, 0x403, 0x40B, 0x418 ) ); 	if ( Utility.RandomBool() ){ CitizenLocalization.SayLocalizedComposite( from, sing, null ); } }		// LUTE
					else if ( this.ItemID == 0x64C0 || this.ItemID == 0x64C1 ){ this.Name = StringCatalog.ResolveByKey(null, "mob.other.instrument");	from.PlaySound( 0x504 ); }																									// FLUTE
					else if ( this.ItemID == 0x64C2 || this.ItemID == 0x64C3 ){ this.Name = StringCatalog.ResolveByKey(null, "mob.other.instrument");	from.PlaySound( Utility.RandomList( 0x043, 0x045 ) ); 	if ( Utility.RandomBool() ){ CitizenLocalization.SayLocalizedComposite( from, sing, null ); } }					// HARP
					else if ( this.ItemID == 0x64C4 || this.ItemID == 0x64C5 ){ this.Name = StringCatalog.ResolveByKey(null, "mob.other.instrument");	from.PlaySound( 0x38 ); 	if ( Utility.RandomBool() ){ CitizenLocalization.SayLocalizedComposite( from, sing, null ); } }												// DRUM
					else if ( this.ItemID == 0x64C6 || this.ItemID == 0x64C7 ){ this.Name = StringCatalog.ResolveByKey(null, "mob.other.instrument");	from.PlaySound( 0x5B1 ); 	if ( Utility.RandomBool() ){ CitizenLocalization.SayLocalizedComposite( from, sing, null ); } }												// FIDDLE
					else if ( this.ItemID == 0x64C8 || this.ItemID == 0x64C9 ){ this.Name = StringCatalog.ResolveByKey(null, "mob.other.instrument");	from.PlaySound( Utility.RandomList( 0x52, 0x4B5, 0x4B6, 0x4B7 ) ); 	if ( Utility.RandomBool() ){ CitizenLocalization.SayLocalizedComposite( from, sing, null ); } }		// TAMBOURINE
					else if ( this.ItemID == 0x64CA || this.ItemID == 0x64CB ){ this.Name = StringCatalog.ResolveByKey(null, "mob.other.instrument");	from.PlaySound( Utility.RandomList( 0x3CF, 0x3D0 ) ); } 																	// TRUMPET
					else if ( this.ItemID == 0x64CC || this.ItemID == 0x64CD ){ this.Name = StringCatalog.ResolveByKey(null, "mob.other.instrument");	from.PlaySound( 0x5B8 ); }																									// PIPES
				}
				else
				{
		...
		public static void SetInstrument( Mobile from, Item instrument )
		{
			...
			if ( facing == "south" )
			{
				...
				{
					case 1:	instrument.ItemID = 0x64BF; instrument.Name = StringCatalog.ResolveByKey(null, "mob.other.lute"); 		instrument.Z = from.Z + 9;	break;
					case 2:	instrument.ItemID = 0x64C1; instrument.Name = StringCatalog.ResolveByKey(null, "mob.other.flute"); 		instrument.Z = from.Z + 11;	break;
					case 3:	instrument.ItemID = 0x64C3; instrument.Name = StringCatalog.ResolveByKey(null, "mob.other.harp"); 		instrument.Z = from.Z + 8;	break;
					case 4:	instrument.ItemID = 0x64C5; instrument.Name = StringCatalog.ResolveByKey(null, "mob.other.drum"); 		instrument.Z = from.Z + 8;	break;
					case 5:	instrument.ItemID = 0x64C7; instrument.Name = StringCatalog.ResolveByKey(null, "mob.other.fiddle"); 	instrument.Z = from.Z + 10;	break;
					case 6:	instrument.ItemID = 0x64C9; instrument.Name = StringCatalog.ResolveByKey(null, "mob.other.tambourine"); instrument.Z = from.Z + 9;	break;
					case 7:	instrument.ItemID = 0x64CB; instrument.Name = StringCatalog.ResolveByKey(null, "mob.other.trumpet"); 	instrument.Z = from.Z + 9;	instrument.Hue = 0xB61;	break;
					case 8:	instrument.ItemID = 0x64CD; instrument.Name = StringCatalog.ResolveByKey(null, "mob.other.pipes"); 		instrument.Z = from.Z + 9;	break;
				}
			}
			else
			{
				switch ( Utility.RandomMinMax( 1, 8 ) )
				{
					case 1:	instrument.ItemID = 0x64BE; instrument.Name = StringCatalog.ResolveByKey(null, "mob.other.lute"); 		instrument.Z = from.Z + 9;	break;
					case 2:	instrument.ItemID = 0x64C0; instrument.Name = StringCatalog.ResolveByKey(null, "mob.other.flute"); 		instrument.Z = from.Z + 11;	break;
					case 3:	instrument.ItemID = 0x64C2; instrument.Name = StringCatalog.ResolveByKey(null, "mob.other.harp"); 		instrument.Z = from.Z + 8;	break;
					case 4:	instrument.ItemID = 0x64C4; instrument.Name = StringCatalog.ResolveByKey(null, "mob.other.drum"); 		instrument.Z = from.Z + 8;	break;
					case 5:	instrument.ItemID = 0x64C6; instrument.Name = StringCatalog.ResolveByKey(null, "mob.other.fiddle"); 	instrument.Z = from.Z + 10;	break;
					case 6:	instrument.ItemID = 0x64C8; instrument.Name = StringCatalog.ResolveByKey(null, "mob.other.tambourine"); instrument.Z = from.Z + 9;	break;
					case 7:	instrument.ItemID = 0x64CA; instrument.Name = StringCatalog.ResolveByKey(null, "mob.other.trumpet"); 	instrument.Z = from.Z + 9;	instrument.Hue = 0xB61;	break;
					case 8:	instrument.ItemID = 0x64CC; instrument.Name = StringCatalog.ResolveByKey(null, "mob.other.pipes"); 		instrument.Z = from.Z + 9;	break;
				}
			}
		}
