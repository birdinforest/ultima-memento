	...
	public class Citizens : BaseCreature
	{
		...
		CitizenRumorZh = null;
			...
			else if ( CitizenType == 24 && CitizenService == 24 )
			{
				...
				crate.ItemID = bottle;
				crate.Name = StringCatalog.ResolveFormatByKey(null, "mob.fmt.crate_of_0", reagent);
			...
			else if ( CitizenType == 25 && CitizenService == 25 )
			{
				...
				crate.ItemID = 0x55DF;
				crate.Hue = jug;
				crate.Name = StringCatalog.ResolveFormatByKey(null, "mob.fmt.crate_of_0", potion);
				crate.Weight = crate.CrateQty * 0.1;
			...
			else if ( CitizenType == 26 && CitizenService == 26 )
			{
				...
				crate.ItemID = eat;
				crate.Name = StringCatalog.ResolveFormatByKey(null, "mob.fmt.crate_of_0", food);
				crate.Weight = crate.CrateQty * 0.1;
		...
		public override void GetProperties(ObjectPropertyList list)
		{
			...
			{
				list.Add(StringCatalog.ResolveByKey(null, "mob.other.recently_questioned"));
			}
		}
