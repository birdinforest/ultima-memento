...

{
...

	{
...

		{
			...
			Name = Server.Localization.StringCatalog.ResolveByKey(null, "mob.other.arachnar");

			Title = Server.Localization.StringCatalog.ResolveByKey(null, "mob.other.the_deep_crawler");
...

{
...

	{
...

		{
			...
			Name = Server.Localization.StringCatalog.ResolveByKey(null, "mob.other.arachnar_s_vault");
